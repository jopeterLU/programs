...
%   program please cite the above reference.
%
...
leftPanel = uipanel('Position', [0.05*500/750 0.05 0.8*500/750 0.9],...
    'Backgroundcolor','default','Visible','on',...
    'Parent',f);
rightTopPanel = uipanel('Position', [0.9*500/750 0.375 1-0.85*500/750-0.1*500/750 0.575],...
    'Backgroundcolor','default','Visible','on',...
    'Parent',f);
rightBottomPanel = uipanel('Position', [0.9*500/750 0.125 1-0.85*500/750-0.1*500/750 0.225],...
    'Backgroundcolor','default','Visible','on',...
    'Parent',f);
...
edit_pre2=uicontrol(rightTopPanel,'Style','edit','String','5','Units','normalized',...
...
edit_dc=uicontrol(rightTopPanel,'Style','edit','String','100','Units','normalized',...
...
edit_pb1=uicontrol(rightTopPanel,'Style','edit','String','6','Units','normalized',...
...
edit_dx=uicontrol(rightTopPanel,'Style','edit','String','0.107','Units','normalized',...
...
Ipb=[];
default_dir='D:\Peter J\Data\';   % Default directory for images
    ...
    function menu_Open_Callback(source,eventdata)
        ...
        [0.05*500/750 0.05 0.8*500/750 0.9],...
            'Visible','on');
        set(ax_f,'Visible','on')
